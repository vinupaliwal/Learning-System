 ...
 */
public class HodDto {
    private String hodid,name,qualification,password,department,bloodgroup,adharnumber,email,phonenumber,joiningyear,gender,dob,address,teachexperience,designation,category;

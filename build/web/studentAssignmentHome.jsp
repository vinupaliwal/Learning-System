...
<head>
	...
	<link rel="stylesheet" href="css/studentAssignmentHome.css">
...
<body>
     <%
        ...
        List<AssignmentDto> listofusers = udao.getCourseData1(enrollment,branch);
		...
		<div class="main">
			...
			<div class="container">
				...
				<div class="card-content">
                                    <a href="studentAssignmentStream.jsp?course=<%=user.getFacultyid()%>&&enrollment=<%=enrollment%>"><%=user.getCourse()%></a>

	...
	<div class="main-content">
		...
		<div class="main">
			<div class="container">
				<div class="cover-photo">
					...
					<div class="buttons">
						<!-- <button class="msg-btn">Message</button> -->
                                                <button class="follow-btn"><a style="color: black" href="updateStudent.jsp?enrollment=<%=user.getEnrollment()%>">Update Profile</a></button>
                                                <button class="follow-btn"><a style="color: black" href="DeleteStudent?enrollment=<%=user.getEnrollment()%>">Delete</a></button>
				...
				<div class="skills">
					<a href=""><span class="fa fa-location-dot"></span> <%=user.getCity()%></a>
					<div>
						<p class="about"><span class="fa fa-pencil"></span> <%=user.getBranch() %> </p>
					</div>
				</div>
				...
				<section class="info">
					...
					<div class="details">
						...
						<div class="details-box">
							<h3>Enrollment No : </h3>
							<div><%=user.getEnrollment() %></div>
						</div>
						<div class="details-box">
							<h3>Father Name : </h3>
							<div><%=user.getFathername() %></div>
						</div>
                                                <div class="details-box">
							<h3>Branch : </h3>

        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li><a href="profileHod.jsp?hodid=<%=hoduser.getHodid() %>" class="active"><span class='bx bx-user-circle'></span><span>Profile</span></a></li>
                ...
                <div class="projects">
                    <div class="recent-card">
                        <div class="card-header">
                            <h3>Faculty</h3>
                            <div class="search">
                                <form action="checkAllFaculty.jsp" method="post">
                        ...
                        <%
                            ...
                            FacultyDto user1 = udao.getUserData(facultyid);
                            if (facultyid != null) {
                        %>                           
   ...
   <td>Id</td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="btn">
                                            <button class="update"><a style="color: white" href="profileFaculty.jsp?facultyid=<%=user1.getFacultyid()%>&category=hod">View</a></button>
                                        </td>
                                    </tr>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="btn">
                                            <button class="update"><a style="color: white" href="profileFaculty.jsp?facultyid=<%=user.getFacultyid() %>">View</a></button>
                                        </td>
                                    </tr>
                                    <%
                                        }

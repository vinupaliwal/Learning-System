		...
		<div class="sidebar-menu">
			<ul>
				<li><a href="admin.jsp" class="active"><span class='bx bxs-dashboard'></span><span>Dashboard</span></a>
                    ...
                    <li><a href="profileHod.jsp" class="active"><span class='bx bx-user-circle'></span><span>Profile</span></a></li>
		...
		<div class="main">
			<div class="container">
				<div class="cover-photo">
					<img src="/rohit.png" alt="" style="height: 120px; width:120px" class=" profile ">
					<div class="buttons">
						<!-- <button class="msg-btn">Message</button> -->
                                                <button class="follow-btn"><a style="color: black" href="updateFaculty.jsp?facultyid=<%=user.getFacultyid()%>">Update Profile</a></button>
